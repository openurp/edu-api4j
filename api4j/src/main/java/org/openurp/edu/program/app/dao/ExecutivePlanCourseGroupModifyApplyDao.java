...
public interface ExecutivePlanCourseGroupModifyApplyDao {
   ...
   * @param after 可以为null
   */
  void saveModifyApply(ExecutiveCourseGroupModify apply, ExecutiveCourseGroupModifyDetailBefore before,
